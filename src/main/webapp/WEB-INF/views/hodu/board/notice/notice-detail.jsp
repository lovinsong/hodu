...
<script>
	...
	$(document).ready(function() {
		...
		function add() {
			...
			var qno = "${dto.notice_postnum}"; //문자열의 형태로 화면에서 넘어온 bno번호
        ...
        function getlist(page,reset) { //(stradd 초기화여부)
            ...
            $.getJSON(
                    ...
                    for(var i=0; i<data.length; i++){
                        ...
                        stradd+="<a href='"+data[i].notice_reply_post+" "+data[i].member_id+"' class='right replyModify'><span class='glyphicon glyphicon-pencil'></span>수정</a>"
                        stradd+="<a href='"+data[i].notice_reply_post+" "+data[i].member_id+"' class='right replyDelete'><span class='glyphicon glyphicon-remove'></span>삭제</a>"
                        stradd+="</div>";
