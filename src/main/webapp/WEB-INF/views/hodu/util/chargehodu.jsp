			...
			<div class="card bg-warning" style="width: 19rem;">
			  ...
			  <div class="card-body">
	            ...
	            <div class="form-check">
				  <input class="form-check-input" type="radio" id="flexRadio1" name="totalPrice" value="5000">
				  <label class="fw-bold form-check-label" for="flexRadio1">50호두 - 5,000원</label>
				  
				  <input class="form-check-input" type="radio" id="flexRadio2"name="totalPrice" value="10000">
				  <label class="fw-bold form-check-label" for="flexRadio2">100호두 - 10,000원</label>
			
				  <input class="form-check-input" type="radio" id="flexRadio3"name="totalPrice" value="20000">
				  <label class="fw-bold form-check-label" for="flexRadio3">200호두 - 20,000원</label>
			
				  <input class="form-check-input" type="radio" id="flexRadio4"name="totalPrice" value="30000">
				  <label class="fw-bold form-check-label" for="flexRadio4">300호두 - 30,000원</label>
			
				  <input class="form-check-input" type="radio" id="flexRadio5"name="totalPrice" value="50000">
				  <label class="fw-bold form-check-label" for="flexRadio5">500호두 - 50,000원</label>
			
				  <input class="form-check-input" type="radio" id="flexRadio6"name="totalPrice" value="100000">
